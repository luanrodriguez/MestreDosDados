...
def test_if_turn_into_emote_works():
    assert(turn_into_emote(20) == '<a:doisbonito:997148113951273062><a:zerobonito:997148111816380558>')
    assert(turn_into_emote(1) == '<a:umbonito:997148137338712084>')
    assert(turn_into_emote(8) == '<a:oitobonito:997148119852646430>')
    assert(turn_into_emote(136) == '<a:umbonito:997148137338712084><a:tresbonito:997148135065407548><a:seisbonito:997148125183623178>')
    assert(turn_into_emote(45) == '<a:quatrobonito:997148132469112872><a:cincobonito:997148129772183603>')
    assert(turn_into_emote(97) == '<a:novebonito:997148116887277568><a:setebonito:997148122042089522>')
